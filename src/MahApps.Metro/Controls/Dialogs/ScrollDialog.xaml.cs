...
namespace MahApps.Metro.Controls.Dialogs
{
    ...
    /// </summary>
    public partial class ScrollDialog : BaseMetroDialog
    {
        ...
        public static readonly DependencyProperty TopMessageProperty = DependencyProperty.Register(nameof(TopMessage), typeof(string), typeof(ScrollDialog), new PropertyMetadata(default(string)));
        public static readonly DependencyProperty BottomMessageProperty = DependencyProperty.Register(nameof(BottomMessage), typeof(string), typeof(ScrollDialog), new PropertyMetadata(default(string)));

        public string TopMessage
        {
            get { return (string)this.GetValue(TopMessageProperty); }
            set { this.SetValue(TopMessageProperty, value); }
        }


        public string BottomMessage
        {
            get { return (string)this.GetValue(BottomMessageProperty); }
            set { this.SetValue(BottomMessageProperty, value); }
        }

        /// <summary>Identifies the <see cref="AffirmativeButtonText"/> dependency property.</summary>
        public static readonly DependencyProperty AffirmativeButtonTextProperty = DependencyProperty.Register(nameof(AffirmativeButtonText), typeof(string), typeof(ScrollDialog), new PropertyMetadata("OK"));
        ...
        public static readonly DependencyProperty NegativeButtonTextProperty = DependencyProperty.Register(nameof(NegativeButtonText), typeof(string), typeof(ScrollDialog), new PropertyMetadata("Cancel"));
        ...
        public static readonly DependencyProperty FirstAuxiliaryButtonTextProperty = DependencyProperty.Register(nameof(FirstAuxiliaryButtonText), typeof(string), typeof(ScrollDialog), new PropertyMetadata("Cancel"));
        ...
        public static readonly DependencyProperty SecondAuxiliaryButtonTextProperty = DependencyProperty.Register(nameof(SecondAuxiliaryButtonText), typeof(string), typeof(ScrollDialog), new PropertyMetadata("Cancel"));
        ...
        public static readonly DependencyProperty ButtonStyleProperty = DependencyProperty.Register(nameof(ButtonStyle), typeof(MessageDialogStyle), typeof(ScrollDialog), new PropertyMetadata(MessageDialogStyle.Affirmative, ButtonStylePropertyChangedCallback));

        private static void ButtonStylePropertyChangedCallback(DependencyObject o, DependencyPropertyChangedEventArgs e)
        {
            if (o is ScrollDialog dialog)
            {
        ...
        internal ScrollDialog(MetroWindow parentWindow)
            : this(parentWindow, null)
        {
        }

        internal ScrollDialog(MetroWindow parentWindow, MetroDialogSettings settings)
        ...
        private static void SetButtonState(ScrollDialog md)
        {
        ...
        {
            // Our implementation doesn't need support for this.
